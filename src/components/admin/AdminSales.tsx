                  ...
                  {isExpanded && (
                    <div className="border-t border-border px-4 pb-4 pt-3 space-y-4">
                      ...
                      <div className="space-y-1">
                        ...
                        {s.customer_phone ? (() => {
                          const waLink = buildWhatsAppLink(s, saleItems[s.id]);
                          return waLink ? (
                            <a
                              href={waLink}
                              target="_blank"
                              ...
                              title="Abrir conversa no WhatsApp com mensagem do pedido"
                            >
                            ...
                            <span className="text-sm text-muted-foreground">{formatPhone(s.customer_phone)}</span>
                          );
                        })() : null}
                      </div>
